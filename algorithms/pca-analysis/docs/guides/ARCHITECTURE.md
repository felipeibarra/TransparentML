...
make train
    ↓
Makefile ejecuta: docker-compose exec pca-analysis python scripts/train.py
    ↓
Contenedor pca-analysis ejecuta Python
    ↓
...
- pca-analysis: ML y procesamiento
- pca-api: Servir predicciones
